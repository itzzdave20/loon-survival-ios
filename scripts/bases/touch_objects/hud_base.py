...
import scripts.screen_objects.health_indicators
HealthIndicator = scripts.screen_objects.health_indicators.DefaultHealthIndicator
import scripts.bases.touch_objects.quadrant_touch_object
QuadrantTouchObject = scripts.bases.touch_objects.quadrant_touch_object.QuadrantTouchObject
import scripts.screen_objects.controllers
LeftController = scripts.screen_objects.controllers.LeftController
RightController = scripts.screen_objects.controllers.RightController
import scripts.screen_objects.player_sprites
DefaultPlayerSprite = scripts.screen_objects.player_sprites.DefaultPlayerSprite
import scripts.bases.window_objects.button_base
ButtonBase = scripts.bases.window_objects.button_base.ButtonBase
import scripts.bases.window_objects.text_base
TextBase = scripts.bases.window_objects.text_base.TextBase
import scripts.screen_objects.hit_rect
HitRect = scripts.screen_objects.hit_rect.HitRect
