...
al = scripts.modules.loaders.audio_loader
...
class BaseAudio:
	def __init__(self, game, player_atk=_D_ATK, player_hit=_D_HIT, npc_atk=_D_NPC_ATK, npc_hit=_D_NPC_HIT, notification=_D_N, beep=_D_B, pause_start=_D_PS, theme=_D_THEME):
		self.game = game
	...
	def re_init(self, player_atk=_D_ATK, player_hit=_D_HIT, npc_atk=_D_NPC_ATK, npc_hit=_D_NPC_HIT, notification=_D_N, beep=_D_B, pause_start=_D_PS, theme=_D_THEME):
