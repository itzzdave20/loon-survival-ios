...
import scripts.bases.base_sprites.animated_sprite
AnimatedSprite = scripts.bases.base_sprites.animated_sprite.AnimatedSprite
import scripts.bases.base_sprites.static_sprite
StaticSprite = scripts.bases.base_sprites.static_sprite.StaticSprite
import scripts.bases.base_sprites.npc_sprite
NPCSprite = scripts.bases.base_sprites.npc_sprite.NPCSprite
import scripts.bases.base_sprites.goal_sprite
BaseGoalSprite = scripts.bases.base_sprites.goal_sprite.BaseGoalSprite
