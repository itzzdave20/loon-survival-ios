...
import scripts.screen_objects.text_card as text_card
globals().update({k: v for k, v in text_card.__dict__.items() if not k.startswith('__')})

import scripts.bases.timed_rect_bases.timed_image_text_rect
TimedImageTextRect = scripts.bases.timed_rect_bases.timed_image_text_rect.TimedImageTextRect
import scripts.bases.timed_rect_bases.text_typing_card
TextTypingCard = scripts.bases.timed_rect_bases.text_typing_card.TextTypingCard
import scripts.bases.applied_bases.text_frame
TextFrame = scripts.bases.applied_bases.text_frame.TextFrame
import scripts.bases.applied_bases.typing_text_frame
TypingTextFrame = scripts.bases.applied_bases.typing_text_frame.TypingTextFrame
