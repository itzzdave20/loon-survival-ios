...
sprite = scripts.scene_objects.sprite_scripts.sprite
import scripts.game.textures as textures
globals().update({k: v for k, v in textures.__dict__.items() if not k.startswith('__')})
import scripts.engine.helper_scripts
coord_cnvrtr = scripts.engine.helper_scripts.coordinates_converter
