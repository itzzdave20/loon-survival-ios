...
import scripts.modules.kivy.quadrant_manager
QManager = scripts.modules.kivy.quadrant_manager.QManager
import scripts.screen_objects.hud_scripts.hit_rect
HitRect = scripts.screen_objects.hud_scripts.hit_rect.HitRect
import scripts.screen_objects.hud_scripts.hud_buttons
HudButtons = scripts.screen_objects.hud_scripts.hud_buttons.HudButtons
import scripts.screen_objects.hud_scripts.player_sprite
PlayerSprite = scripts.screen_objects.hud_scripts.player_sprite.PlayerSprite
import scripts.screen_objects.hud_scripts.controller
LeftController = scripts.screen_objects.hud_scripts.controller.LeftController
RightController = scripts.screen_objects.hud_scripts.controller.RightController
import scripts.screen_objects.hud_scripts.player_health_register
PlayerHealthRegister = scripts.screen_objects.hud_scripts.player_health_register.PlayerHealthRegister
