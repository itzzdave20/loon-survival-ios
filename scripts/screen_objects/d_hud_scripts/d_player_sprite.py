...
import scripts.base_classes.loop_doonce_iter_timed_base
SeqImageLoopDoOnceIterRect = scripts.base_classes.loop_doonce_iter_timed_base.SeqImageLoopDoOnceIterRect

import scripts.base_classes.base_sprite
ScreenSprite = scripts.base_classes.base_sprite.ScreenSprite
