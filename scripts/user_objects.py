...
import scripts.game.audio
Audio = scripts.game.audio.Audio
import scripts.game.player
Player = scripts.game.player.Player
import scripts.scene_objects.sky
Sky = scripts.scene_objects.sky.Sky
import scripts.scene_objects.floor
Floor = scripts.scene_objects.floor.Floor
