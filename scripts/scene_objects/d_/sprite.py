...
Rectangle = kivy.graphics.vertex_instructions.Rectangle
import kivy.graphics.context_instructions
Color = kivy.graphics.context_instructions.Color
import kivy.core.image
Image = kivy.core.image.Image
...
import scripts.game.textures as textures
globals().update({k: v for k, v in textures.__dict__.items() if not k.startswith('__')})

import scripts.scene_objects.sprite_scripts
npc_animation = scripts.scene_objects.sprite_scripts.npc_animation
import scripts.scene_objects.sprite_scripts
npc_behavior = scripts.scene_objects.sprite_scripts.npc_behavior
import scripts.base_classes.base_sprite
SceneSprite = scripts.base_classes.base_sprite.SceneSprite
