...
import scripts.bases.base_player
BasePlayer = scripts.bases.base_player.BasePlayer
...
class DefaultPlayer(BasePlayer):
	def __init__(self, game, player_pos_x=_PX, player_pos_y=_PY, player_angle=_A,
		...
		super().__init__(game=game, pos_x=float(player_pos_x), pos_y=float(player_pos_y), 
