...
import scripts.modules.loaders.user_config_loader as user_config_loader
globals().update({k: v for k, v in user_config_loader.__dict__.items() if not k.startswith('__')})
