...
import scripts.modules.npc_scripts.npc_helper_functions as npc_helper_functions
globals().update({k: v for k, v in npc_helper_functions.__dict__.items() if not k.startswith('__')})
