...
import scripts.cards.menu_card
MenuCard = scripts.cards.menu_card.MenuCard
import scripts.cards.typing_card
TypingCard = scripts.cards.typing_card.TypingCard
import scripts.cards.score_card
ScoreCard = scripts.cards.score_card.ScoreCard
import scripts.bases.touch_objects.touch_object
TouchObject = scripts.bases.touch_objects.touch_object.TouchObject
