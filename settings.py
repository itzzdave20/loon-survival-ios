...
RAY_STEPS = 0.25
RAYCAST_COLLISION_PEAK_DISTANCE = 0.01
...
BLOCK_OFFSET = 5
# Increased grid resolution for more faithful layouts (e.g., Doom maps)
NUMBER_OF_BLOCKS_ACROSS = 64
...
MENU_TEXTURES = "scripts/resources/textures/menu/", EMPTY_PATH
GAME_TEXTURES = "scripts/resources/textures/game/", EMPTY_PATH
DIGIT_TEXTURES = "scripts/resources/textures/digits/", EMPTY_PATH
...
# # is replaced with \n
SAMPLE_TEXT = "[b]How to Play[/b]#• Move to explore the map#• Avoid enemies and dangerous areas#• Reach the ship to survive#• Tap [b]SHIP[/b] to begin##GoodLuck Survivors"
